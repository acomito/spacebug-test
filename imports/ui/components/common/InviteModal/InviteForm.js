  ...
  handleSubmit = (e) => {
    ...
    this.props.form.validateFields((err, values) => {
      if (err) { return this.setState({loading: false}) }
        ...
        setTimeout(()=>{
          message.success('your invites were sent!')
  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmit}>
        ...
        <FormItem {...formItemLayoutWithOutLabel}>
          <Button type="primary" htmlType="submit" size="large" loading={this.state.loading}>Send Invites</Button>
        </FormItem>
      </Form>
    );
  }
